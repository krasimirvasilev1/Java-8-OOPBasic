package ExamNeedForSpeed.src.nfs.core;

import ExamNeedForSpeed.src.nfs.entities.cars.Car;
import ExamNeedForSpeed.src.nfs.entities.essentials.Garage;
import ExamNeedForSpeed.src.nfs.entities.races.Race;
import ExamNeedForSpeed.src.nfs.factories.CarFactory;
import ExamNeedForSpeed.src.nfs.factories.RaceFactory;
import ExamNeedForSpeed.src.nfs.utilities.Constants;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import static ExamNeedForSpeed.src.nfs.utilities.Constants.RACE_HAS_NO_PARTICIPANTS_MESSAGE;
